...
|post| /user_segments| создание пользователя в сегмент|
|put| /user_segments/id| редактирование данных о пользователях|
|get| /user_segments/id| получение активных сегментов|

3. Исходя из задания мне стало понятно, что необходимо 2 сущности для хранения - Сегменты и Пользовательские данные.

4. Также было реализовано дополнительное задание по добавлению пользователю TTL. Было решено задать его датой, а само механизм удаления переложить на триггер в спроектированной БД.
